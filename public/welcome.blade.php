...
<body>
    ...
    <div class="container">
        <div class="profile">
            <img id="profileImage" src="" alt="Dave Ivan Ducusin">
            <h1>Dave Ivan Ducusin</h1>
        ...
        <section class="projects">
            <div class="project">
                <img id="project1Image" src="" alt="Project 1">
    ...
    <script>
        // Function to load images dynamically using AJAX (Fetch API)
        async function loadImages() {
            try {
                // Example URLs of images hosted online (e.g., Imgur)
                const profileImageUrl = 'https://i.imgur.com/your-profile-image.jpg';
                const project1ImageUrl = 'https://imgur.com/OImNlDC';
                const project2ImageUrl = 'https://i.imgur.com/your-project2-image.jpg';
                const project3ImageUrl = 'https://i.imgur.com/your-project3-image.jpg';
                
                // Setting the src attribute of image elements
                document.getElementById('profileImage').src = profileImageUrl;
                document.getElementById('project1Image').src = project1ImageUrl;
                document.getElementById('project2Image').src = project2ImageUrl;
                document.getElementById('project3Image').src = project3ImageUrl;
            } catch (error) {
